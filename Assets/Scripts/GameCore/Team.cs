...
public sealed class Team {
	...
	public static readonly Team TEAM_2 = new Team("team_name", Color.blue,1, TeamID.TEAM_2);
	public static readonly Team TEAM_3 = new Team("Curry Soup", Color.green,2, TeamID.TEAM_3);
