...
namespace UnityEngine.EventSystems
{
	...
	[AddComponentMenu("Event/Dada Input Module")]
	public class DadaInputModule : PointerInputModule
	{
		...
		[SerializeField]
		private VirtualKey m_HorizontalAxis = VirtualKey.X_AXIS;
		
		/// <summary>
		/// Name of the vertical axis for movement (if axis events are used).
		/// </summary>
		[SerializeField]
		private VirtualKey m_VerticalAxis = VirtualKey.Y_AXIS;
		
		/// <summary>
		/// Name of the submit button.
		/// </summary>
		[SerializeField]
		private VirtualKey m_SubmitButton = VirtualKey.SUBMIT;
		
		/// <summary>
		/// Name of the submit button.
		/// </summary>
		[SerializeField]
		private VirtualKey m_CancelButton = VirtualKey.CANCEL;
		...
		/// </summary>
		public VirtualKey horizontalAxis
		{
		...
		/// Name of the vertical axis for movement (if axis events are used).
		/// </summary>
		public VirtualKey verticalAxis
		{
			get { return m_VerticalAxis; }
			set { m_VerticalAxis = value; }
		}
		
		public VirtualKey submitButton
		{
			get { return m_SubmitButton; }
			set { m_SubmitButton = value; }
		}
		
		public VirtualKey cancelButton
		{
